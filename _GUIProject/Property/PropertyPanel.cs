...
namespace _GUIProject.UI
{
    public class PropertyPanel
    {
        ...
        private TextProperty _textProperties;
        private SurfaceProperty _surfaceProperties;
        private GeneralProperty _generalProperties;
        private AdvancedProperty _advancedProperties;

        private readonly SortedDictionary<UIObject, Point> _properties;
        public PropertyPanel(UIObject owner)
        {
            Owner = owner;                
            BGImage = new Sprite("PropertyPanelTX", UIObject.DrawPriority.NORMAL);
